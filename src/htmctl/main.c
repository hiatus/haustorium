...
static void _htm_info(void)
{
	...
	printf(
		...
		HTM_PID, HTM_SIG_DISABLE_CDD, HTM_SIG_DISABLE_FS, HTM_SIG_DISABLE_NF,
		HTM_SIG_ENABLE_CDD, HTM_SIG_ENABLE_FS, HTM_SIG_ENABLE_NF, HTM_SIG_HIDE_MODULE,
		HTM_SIG_SHOW_MODULE, HTM_SIG_STATUS, HTM_SIG_SUDO
	);
}
